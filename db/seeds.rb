...
User.create(name: 'Amin', email: 'ab@amin.com', password: '12345', password_confirmation: '12345')
User.create(name: 'Lera', email: 'lera@lera.com', password: '12345', password_confirmation: '12345')
User.create(name: 'Jamie', email: 'Jamie@Jamie.com', password: '12345', password_confirmation: '12345')
User.create(name: 'Sam', email: 'sam@sam.com', password: '12345', password_confirmation: '12345')
